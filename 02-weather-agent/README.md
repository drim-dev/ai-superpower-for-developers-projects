...
ИИ-агент для получения информации о погоде, демонстрирующий **ручную реализацию протокола инструментов** в учебных целях. Вместо использования встроенных API для вызова функций, проект парсит вызовы инструментов напрямую из текстовых ответов LLM.
